# Generated by Django 2.1.3 on 2019-02-16 14:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('file_path', models.CharField(max_length=200, verbose_name='路径')),
                ('isDelete', models.IntegerField(choices=[('0', '否'), ('1', '是')], default=0, verbose_name='是否删除')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
        ...
        migrations.AddField(
            model_name='productmembers',
            name='role',
            field=models.ForeignKey(db_column='role', on_delete=django.db.models.deletion.CASCADE, to='app.Group', to_field='group'),
        ),
        migrations.AddField(
            model_name='product',
            name='creator_id',
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ForeignKey(db_column='group', on_delete=django.db.models.deletion.CASCADE, to='app.Group', to_field='group'),
        ),
    ]
