# Generated by Django 2.0 on 2018-10-06 20:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('page_name', models.CharField(max_length=100, unique=True, verbose_name='权限名称')),
                ('page_url', models.CharField(max_length=200, unique=True, verbose_name='权限code')),
                ('flag', models.CharField(max_length=200, verbose_name='标记')),
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
            ],
            options={
