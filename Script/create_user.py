...
# sql
user_sql = "insert into `t_user` ( `user_id`, `email`, `password`, `mobile`, `user_status`, `realname`, `position`, `gender`, `avatarUrl`, `province`, `city`, `source`, `create_time`, `update_time`, `group`) values ( '{0}', '{1}', '{2}', null, '1', '超级管理员', null, '1', null, null, null, null, '{3}', '{4}', 'admin');".format(suid,email,encrypt_passwd,curremt_time,curremt_time)
